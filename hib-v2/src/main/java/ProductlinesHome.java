...
/**
 * Home object for domain model class Productlines.
 * @see .Productlines
 * @author Hibernate Tools
 */
public class ProductlinesHome {

	private static final Log log = LogFactory.getLog(ProductlinesHome.class);
	...
	public void persist(Productlines transientInstance) {
		log.debug("persisting Productlines instance");
		try {
	...
	public Productlines merge(Productlines detachedInstance) {
		...
		try {
			Productlines result = (Productlines) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Productlines findById(java.lang.String id) {
		...
		try {
			Productlines instance = (Productlines) sessionFactory.getCurrentSession().get("Productlines", id);
			if (instance == null) {
	...
	public List findByExample(Productlines instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Productlines")
