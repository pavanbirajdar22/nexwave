...
public class OrdersHome {
	...
	public Orders merge(Orders detachedInstance) {
		...
		try {
			Orders result = (Orders) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Orders findById(int id) {
		...
		try {
			Orders instance = (Orders) sessionFactory.getCurrentSession().get("Orders", id);
			if (instance == null) {
	...
	public List findByExample(Orders instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Orders").add(Example.create(instance))
					.list();
